...
export declare class BackendGeoService implements AbstractBackendGeoService {
    ...
    constructor(backendConfig: BackendGeoServiceConfigType, knex: any, gpxParser: BackendGeoGpxParser, txtParser: BackendGeoTxtParser, gpxUtils: GeoGpxUtils, geoEntityDbMapping: GeoEntityTableDbMapping);
