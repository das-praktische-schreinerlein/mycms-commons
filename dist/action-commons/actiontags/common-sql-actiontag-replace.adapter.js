...
var CommonSqlActionTagReplaceAdapter = /** @class */ (function () {
    ...
    CommonSqlActionTagReplaceAdapter.prototype.executeActionTagReplace = function (table, id, actionTagForm, opts) {
        ...
        if (newIdSetNull) {
            ...
            for (var _a = 0, joinConfigs_1 = joinConfigs; _a < joinConfigs_1.length; _a++) {
                var joinConfig = joinConfigs_1[_a];
                updateSqlQueries.push({
            ...
            for (var _b = 0, referenceConfigs_2 = referenceConfigs; _b < referenceConfigs_2.length; _b++) {
                var referenceConfig = referenceConfigs_2[_b];
                updateSqlQueries.push({
                    sql: 'UPDATE ' + referenceConfig.table +
            ...
            for (var _c = 0, joinConfigs_2 = joinConfigs; _c < joinConfigs_2.length; _c++) {
                var joinConfig = joinConfigs_2[_c];
                updateSqlQueries.push({
