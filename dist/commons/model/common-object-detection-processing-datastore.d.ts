import { ObjectDetectionDetectedObjectType, ObjectDetectionRequestType, ObjectDetectionResponseType } from './objectdetection-model';
...
export interface CommonObjectDetectionProcessingDatastore {
    ...
    processDetectionWithResult(detector: string, detectionResult: ObjectDetectionDetectedObjectType, tableConfig: ObjectDetectionEntityDatastoreConfiguration): Promise<any>;
