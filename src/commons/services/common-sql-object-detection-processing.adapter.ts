...
import {SelectQueryData, SqlQueryBuilder} from '../../search-commons/services/sql-query.builder';
import {
...
} from '../model/common-sql-object-detection.model';
