...
import {StaticPagesDataService} from './staticpages-data.service';
...
describe('StaticPagesDataService', () => {
    let pDoc1: PDocRecord = undefined;
    let pDoc2: PDocRecord = undefined;
    let service: StaticPagesDataService;
    let datastore: StaticPagesDataStore;
